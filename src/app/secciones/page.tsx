            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-16 mt-5 mx-10">
                ...
                <div className='flex flex-col items-center justify-center bg-white bg-opacity-50 py-10 px-10' style={{
                  ...
                  <Image
                      ...
                      className='mb-1'
                  />
                  <Link href={`/preguntas`} className="font-smooch text-2xl rounded-full bg-black px-5 py-1 mt-1 w-full uppercase text-white hover:bg-gray-800 border border-gray-800 text-center">ACEPTAR</Link>
                </div>
            </div>
        </main>
    )
