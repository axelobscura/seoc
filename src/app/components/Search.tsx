  ...
  return(
    <div className='my-2 w-full'>
        <label className="flex items-center justify-center relative block">
            ...
            <input ref={myRef} className="placeholder:italic placeholder:text-slate-400 text-gray-900 block bg-white w-1/2 border border-slate-300 rounded-full py-5 px-7 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Buscar por contenidos..." type="text" name="search"/>
