...
export default function Perfil() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24" style={{
      ...
      <MenuSuperior/>
      <Link href={`/secciones`}>
          <h3 className='font-smooch text-3xl text-gray-950 bg-white py-3 px-10 md:px-36 mb-2 rounded-full shadow-lg'>PERFIL</h3>
      </Link>
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 mt-5">
        <div className='flex flex-col items-center justify-between bg-white bg-opacity-50 py-10 px-10 shadow-lg'>
          <h4 className='font-smooch text-2xl text-gray-950 py-1 mb-2 border-b-2 border-gray-900 p-4 text-center w-full'>SUPERVISOR DE OBRAS DE CONCRETO</h4>
